package com.sam.rentalcar.ui.dialog;
...
import com.sam.rentalcar.common.MyAdapter;
...
public final class AddressDialog {
    ...
    private final static class RecyclerViewAdapter extends MyAdapter<List<AddressBean>> {
        ...
        final class ViewHolder extends MyAdapter.ViewHolder implements BaseAdapter.OnItemClickListener {
