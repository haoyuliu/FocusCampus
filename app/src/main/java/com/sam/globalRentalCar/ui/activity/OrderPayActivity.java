    ...
    protected void initData() {
        ...
        mButtonPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 订单id
                payOrderRequestBean.setOrderCode(orderId);
                // 1表示支付宝支付
                payOrderRequestBean.setPayWay(1);
                RetrofitClient.getRetrofitService().getUserPayOrder(token, payOrderRequestBean)
                        .enqueue(new Callback<PayOrderResponseBean>() {
                            @Override
                            ...
                            @Override
                            public void onFailure(Call<PayOrderResponseBean> call, Throwable t) {
                                toast("网络错误");
                            }
                        });
            }
